...
def convert_glue_examples_to_features(examples, tokenizer, task, max_seq_length, is_training):
    ...
    for example_index, example in tqdm(enumerate(examples)):
        ...
        inputs = tokenizer.encode_plus(*args, max_length=max_seq_length, truncation_strategy="longest_first" if sentence2_key is None else "only_second", pad_to_max_length=True)
